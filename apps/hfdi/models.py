...
class HfdiProjectsDailyCollectionsData(models.Model):
    ...
    unit_status = models.CharField(max_length=200, null=False, blank=False, verbose_name="Unit Status")
    sale_month = models.DateField(null=False, blank=False, verbose_name="Sale Month")
    unit_value = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True, verbose_name="Unit Value")
    paid_month = models.DateField(null=False, blank=False, verbose_name="Paid Month")
    entry_month = models.DateField(null=False, blank=False, verbose_name="Entry Month")
    verified = models.CharField(max_length=200, null=False, blank=False, verbose_name="Verified")
    paid_amount = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True, verbose_name="Paid Amount")
    staff_name = models.CharField(max_length=200, null=False, blank=False, verbose_name="Staff Name")
...
class HfdiProjectsInventorySalesData(models.Model):
    ...
    staff_name = models.CharField(max_length=200, null=False, blank=False, verbose_name="Staff Name")
    unit_value = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True, verbose_name="Unit Value")
    payment_mode = models.CharField(max_length=200, null=False, blank=False, verbose_name="Payment Mode")
    booking_date = models.DateField(null=False, blank=False, verbose_name="Booking Date")
    sale_month = models.DateField(null=False, blank=False, verbose_name="Sale Month")
    total_payments = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True, verbose_name="Total Payments")
    perc_paid = models.DecimalField(max_digits=6, decimal_places=5, null=True, blank=True, verbose_name="% Paid")
    perc_paid_prev_month = models.DecimalField(max_digits=6, decimal_places=5, null=True, blank=True, verbose_name="% Paid Prev Month")
    prev_year_paid_amounts = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True, verbose_name="Prev Year Paid Amounts")
    curr_year_paid_amounts = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True, verbose_name="Curr Year Paid Amounts")
    jan_paid_amount = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True, verbose_name="Jan Paid Amount")
    feb_paid_amount = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True, verbose_name="Feb Paid Amount")
    mar_paid_amount = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True, verbose_name="Mar Paid Amount")
    apr_paid_amount = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True, verbose_name="Apr Paid Amount")
    may_paid_amount = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True, verbose_name="May Paid Amount")
    jun_paid_amount = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True, verbose_name="Jun Paid Amount")
    jul_paid_amount = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True, verbose_name="Jul Paid Amount")
    aug_paid_amount = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True, verbose_name="Aug Paid Amount")
    sep_paid_amount = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True, verbose_name="Sep Paid Amount")
    oct_paid_amount = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True, verbose_name="Oct Paid Amount")
    nov_paid_amount = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True, verbose_name="Nov Paid Amount")
    dec_paid_amount = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True, verbose_name="Dec Paid Amount")
...
class AffordableHousingApplication(models.Model):
    application_id = models.CharField(max_length=200, null=False, blank=False, verbose_name="Application ID")
